...
class LevelScene extends Phaser.Scene {
  constructor(){super('LevelScene');this.collected=0;this.totalFlowers=0;this.finished=false;this.finishStarted=false;this.lastBlowAt=0;this.currentSpeed=0;
    this.jumpCount=0;this.facing=1;this.wasGrounded=false;this.walkTime=0;this.jumpWasDown=false;this.jumpLocked=false;}
  ...
  startFinishSequence(){if(this.finishStarted||this.collected<this.totalFlowers)return;this.finishStarted=true;this.finished=true;this.finishCameraX=this.cameras.main.scrollX;this.cameraTargetX=this.finishCameraX;this.cameras.main.stopFollow();this.cameras.main.scrollX=this.finishCameraX;this.finishCameraX=this.cameras.main.scrollX;this.cameras.main.stopFollow();this.cameras.main.scrollX=this.finishCameraX;this.player.body.setVelocity(0,0);/* v54: camera pan uitgeschakeld tijdens finish */this.time.delayedCall(420,()=>this.playFlowerGiftAnimation());}
...
// v54-double-jump marker

// build-marker: v54-double-jump

// build-marker: v54-double-jump

// build-marker: v54-double-jump-levelscene
...
// v54 double jump patch placeholder
